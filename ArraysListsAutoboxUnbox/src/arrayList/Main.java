...
public class Main {
    ...
    private static void changeItem() {
        ...
        myList.printGroceryList();
        System.out.print("Please enter the number of the item you wish to change: ");
        int itemToChange = scanner.nextInt();
        ...
        myList.modifyGroceryItem(itemToChange -1, newItem);
